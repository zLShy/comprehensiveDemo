 ...
 */
class KGSlideMenu @JvmOverloads constructor(context: Context,attributeSet: AttributeSet? = null,defStyleStr: Int = 0):HorizontalScrollView(context,attributeSet,defStyleStr) {
    ...
    override fun onScrollChanged(l: Int, t: Int, oldl: Int, oldt: Int) {
        ...
        ViewCompat.setTranslationX(menuView, menuScale.toFloat())
    }
